...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bluemn Core bluemn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bluemn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bluemn transaction") + "\n" +
              "  bluemn-tx [options] -create [commands]   " + _("Create hex-encoded bluemn transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bluemn transaction
