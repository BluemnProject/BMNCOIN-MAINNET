...
2. run bluemnd with -printalert or -sendalert like this:
   /path/to/bluemnd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    //  1000 for longer invalid proof-of-work chain
    //  Higher numbers mean higher priority
    alert.nPriority     = 5000;
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bluemn.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Bluemn Core:0.12.0.58/"));
