...
#define BOOST_TEST_MODULE Bluemn Test Suite

#include "test_bluemn.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bluemn_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
