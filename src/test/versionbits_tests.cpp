...
BOOST_AUTO_TEST_CASE(versionbits_test)
{
    for (int i = 0; i < 64; i++) {
        ...
        VersionBitsTester().TestDefined()
                           ...
                           .Mine(1000, TestTime(30002), 0x100).TestFailed()
        ...
        // DEFINED -> STARTED -> FAILED
                           ...
                           .Mine(1000, TestTime(10000), 0x100).TestStarted() // So that's what happens the next period
        ...
        // DEFINED -> STARTED -> FAILED while threshold reached
                           ...
                           .Mine(1000, TestTime(10000), 0x101).TestStarted() // So that's what happens the next period
