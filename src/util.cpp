...
const char * const BITCOIN_CONF_FILENAME = "bluemn.conf";
const char * const BITCOIN_PID_FILENAME = "bluemnd.pid";
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "bluemn" is a composite category enabling all Bluemn-related debug output
            if(ptrCategory->count(string("bluemn"))) {
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\BluemnCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\BluemnCore
    // Mac: ~/Library/Application Support/BluemnCore
    // Unix: ~/.bluemncore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BluemnCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BluemnCore";
#else
    // Unix
    return pathRet / ".bluemncore";
#endif
#endif
}
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty bluemn.conf if it does not excist
        FILE* configFile = fopen(GetConfigFile().string().c_str(), "a");
        if (configFile != NULL) {
             std::string strHeader = "# Default nodes config, the other config please put above this line\n"
                                     "addnode=node-01.bluemncoin.com:15003\n"
                                     "addnode=node-02.bluemncoin.com:15003\n"
                                     "addnode=node-03.bluemncoin.com:15003\n"
                                     "addnode=node-04.bluemncoin.com:15003\n"
                                     "addnode=node-05.bluemncoin.com:15003\n"
                                     "addnode=node-06.bluemncoin.com:15003\n"
                                     "addnode=node-07.bluemncoin.com:15003\n"
                                     "addnode=node-08.bluemncoin.com:15003\n"
                                     "addnode=node-09.bluemncoin.com:15003\n"
                                     "addnode=node-10.bluemncoin.com:15003\n"
                                     "addnode=node-01.bluemn.io:15003\n"
                                     "addnode=node-02.bluemn.io:15003\n"
                                     "addnode=node-03.bluemn.io:15003\n"
                                     "addnode=node-04.bluemn.io:15003\n"
                                     "addnode=node-05.bluemn.io:15003\n"
                                     "addnode=node-06.bluemn.io:15003\n"
    ...
    {
        // Don't overwrite existing settings so command line settings override bluemn.conf
