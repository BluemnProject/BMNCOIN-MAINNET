 ...
 *
 *   // network
 *   CBluemnNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bluemn.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBluemnNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BluemnNetwork
// //   -- signature requirements : Key1(User)
// class CBluemnNetworkVariable : public CGovernanceObject
// {
// private:
