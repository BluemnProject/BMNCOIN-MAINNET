    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bluemn Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bluemn Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bluemn-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bluemn in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BMN, 0.1 BMN, 1 BMN and 10 BMN -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bluemn Core is shutting down...") + "<br /><br />" +
