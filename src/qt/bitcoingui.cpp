    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bluemn Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bluemn address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bluemn: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bluemn Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bluemn Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bluemn Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bluemn addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bluemn addresses"));
    ...
    openAction->setStatusTip(tr("Open a bluemn: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bluemn Core help message to get a list with possible Bluemn Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bluemn Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bluemn network", "", count));
    } else {
...
{
    QString strTitle = tr("Bluemn Core"); // default title
