...
* bluemn.conf: contains configuration settings for bluemnd or bluemn-qt
* bluemnd.pid: stores the process id of bluemnd while running
...
* debug.log: contains debug information and general logging generated by bluemnd or bluemn-qt
